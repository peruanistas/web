...
const WEATHER_API_URL = 'https://api.openweathermap.org/data/2.5/weather?lat=-12.066981&lon=-77.055996&lang=es&units=metric&appid=' + import.meta.env.VITE_OPENWEATHER_API_KEY;
...
export function WeatherFeedCard() {
  ...
  const city = data.name || 'Lima';
  const dateStr = getDayString(data.dt, data.timezone);
